{
    ...
    'depends': ['base', 'sale_management', 'purchase', 'stock', 'contacts', 'coupon', 'delivery'],
...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'pragtech_woo_commerce/static/src/js/tree_view_button.js',
            'pragtech_woo_commerce/static/src/js/woo_graph_widget.js',
        ],
        'web.assets_qweb': [
