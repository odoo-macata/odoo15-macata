            ...
            if (this.$buttons) {
               ...
               $(this.$buttons).find('.oe_so_import_button').on('click', function() {
                ...
                $(this.$buttons).find('.oe_attribute_import_button').on('click', function() {
                 ...
                 $(this.$buttons).find('.oe_coupon_import_button').on('click', function() {
                    var d = self.do_action('pragtech_woo_commerce.action_wizard_woo_import_coupon_instance', {
                        additional_context: {},
                    }).then(function(){
                           $('button[name="import_coupon_instance"]').on('click', function(){
                               setTimeout(function(){
                                   window.location.reload();
                               },1500);
                           });
                 ...
                 $(this.$buttons).find('.oe_delivery_carrier_import_button').on('click', function() {
                    var d = self.do_action('pragtech_woo_commerce.action_wizard_woo_import_shipping_method_instance', {
                        additional_context: {},
                    }).then(function(){
                           $('button[name="import_shipping_method_instance"]').on('click', function(){
                               setTimeout(function(){
                                   window.location.reload();
                               },1500);
                           });
                 ...
                 $(this.$buttons).find('.oe_payment_acquirer_import_button').on('click', function() {
                    var d = self.do_action('pragtech_woo_commerce.action_wizard_woo_import_payment_gateway_instance', {
                        additional_context: {},
                    }).then(function(){
                           $('button[name="import_payment_gateway_instance"]').on('click', function(){
                               setTimeout(function(){
                                   window.location.reload();
                               },1500);
                           });
                 ...
                 $(this.$buttons).find('.oe_refund_import_button').on('click', function() {
                    var d = self.do_action('pragtech_woo_commerce.action_woo_import_refund_instance', {
                        additional_context: {},
                    }).then(function(){
                           $('button[name="import_refund_instance"]').on('click', function(){
                               setTimeout(function(){
                                   window.location.reload();
                               },1500);
                           });
